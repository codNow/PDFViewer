...
public class LockFolderAdapter extends RecyclerView.Adapter<LockFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public LockFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
