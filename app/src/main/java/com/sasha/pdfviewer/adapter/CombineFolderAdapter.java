...
public class CombineFolderAdapter extends RecyclerView.Adapter<CombineFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public CombineFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
