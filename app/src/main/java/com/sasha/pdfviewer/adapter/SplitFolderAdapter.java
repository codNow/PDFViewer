...
public class SplitFolderAdapter extends RecyclerView.Adapter<SplitFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public SplitFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
