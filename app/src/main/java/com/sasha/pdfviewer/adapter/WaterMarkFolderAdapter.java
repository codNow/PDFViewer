...
public class WaterMarkFolderAdapter extends RecyclerView.Adapter<WaterMarkFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public WaterMarkFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
