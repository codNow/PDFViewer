...
public class ConvertPdfAdapter extends RecyclerView.Adapter<ConvertPdfAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public ConvertPdfAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
    ...
    public int counFiles(){
        int count = 0;

        String folders = Environment.getExternalStorageDirectory()+"/Converted PDF/";

        for (PdfModel pdfModel : fileArrayList){
