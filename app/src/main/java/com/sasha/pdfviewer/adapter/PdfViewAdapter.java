...
public class PdfViewAdapter extends RecyclerView.Adapter<PdfViewAdapter.ViewHolder> {
    ...
    private ArrayList<PdfModel> modelPdfs;
    OnItemClicks onItemClicks;
    OnFileLongClick onFileLongClick;
    public boolean selectMode = false;

    public PdfViewAdapter(Context context, ArrayList<PdfModel> modelPdfs,
                          OnItemClicks onItemClicks,
                          OnFileLongClick onFileLongClick) {
    ...
    public void exitSelectMode() {
        selectMode = false;
        for (PdfModel recentModel : modelPdfs) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        PdfModel modelPdf = modelPdfs.get(position);
            ...
            public boolean onLongClick(View view) {
                ...
                if (selectMode){
                    ...
                    if (modelPdf.isSelected()){
                        ...
                        if (!modelPdfs.contains(modelPdf)){
                            modelPdfs.add(modelPdf);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectMode){
                    ...
                    intent.putExtra("path", modelPdf.getPath().toString());
            ...
            public void onClick(View v) {
                ...
                rename_linear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        final File renameFile = new File(modelPdfs.get(position).getPath());
                        int index3 = modelPdfs.lastIndexOf(Environment.getExternalStorageDirectory());
                        String folderName = modelPdfs.get(position).getPath().substring(index3 + 1);
            ...
            new CountDownTimer(1000, 1000){
                ...
                public void onFinish() {
                    ...
                    try{
                        ...
                        String paths = modelPdfs.get(position).getPath();
                        ...
                        if (removeFile){
                            ...
                            notifyDataSetChanged();
                            successPopup(newPath, newName, view, position);
                        }
    ...
    private void successPopup(String dest, String title, View view, int position){
        ...
        word_icon.setImageDrawable(context.getDrawable(R.drawable.ic_baseline_edit_24));
    ...
    private void shareFile(int position, View view){
        Uri uri = Uri.parse(modelPdfs.get(position).getPath());
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Uri contentUri = ContentUris.withAppendedId(
                        ...
                        Long.parseLong(modelPdfs.get(position).getId()));*/
                File file = new File(modelPdfs.get(position).getPath());
                ...
                if (deleted){
                   /* context.getApplicationContext().getContentResolver()
                    ...
                    notifyItemRangeChanged(position,modelPdfs.size());
    ...
    public int getSelectedPosition() {
        for (int i = 0; i < modelPdfs.size(); i++) {
            PdfModel pdfModel = modelPdfs.get(i);
    ...
    public void updateSearchList(ArrayList<PdfModel> searchList) {
        modelPdfs = new ArrayList<>();
        modelPdfs.addAll(searchList);
        notifyDataSetChanged();
    }
