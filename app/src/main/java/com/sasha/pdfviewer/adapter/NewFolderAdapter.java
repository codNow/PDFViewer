...
public class NewFolderAdapter extends RecyclerView.Adapter<NewFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public NewFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
