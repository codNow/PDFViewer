...
public class UnlockFolderAdapter extends RecyclerView.Adapter<UnlockFolderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<PdfModel> fileArrayList;

    public UnlockFolderAdapter(Context context, ArrayList<PdfModel> fileArrayList) {
