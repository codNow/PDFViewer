package com.sasha.pdfviewer.cropper;
...
public final class CropImage {
    ...
    /** The key used to pass crop image source URI to {@link ImageCroperActivity}. */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /** The key used to pass crop image options to {@link ImageCroperActivity}. */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /** The key used to pass crop image bundle data to {@link ImageCroperActivity}. */
    public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

    /** The key used to pass crop image result data back from {@link ImageCroperActivity}. */
    ...
    /**
     * The request code used to start {@link ImageCroperActivity} to be used on result to identify the
     * this specific request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /** The result code used to return error from {@link ImageCroperActivity}. */
    ...
    public static boolean hasPermissionInManifest(
            Context context, String permissionName) {
     ...
     * ImageCroperActivity} to crop the selected image.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link ImageCroperActivity} to crop the given
     * image.<br>
    ...
    /**
     * Get {@link ImageCroperActivity} result data object for crop image activity started using {@link
     * #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /** Get {@link ImageCroperActivity} intent to start the activity. */
        public Intent getIntent(Context context) {
            return getIntent(context, ImageCroperActivity.class);
        }
        ...
        /**
         * Start {@link ImageCroperActivity}.
         *
         ...
         */
        public void start(
                Context context, Fragment fragment, Class<?> cls) {
        ...
        public void start(
                Context context, android.app.Fragment fragment, Class<?> cls) {
            fragment.startActivityForResult(getIntent(context, cls), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
        ...
        /**
         * the title of the {@link ImageCroperActivity}.<br>
         * <i>Default: ""</i>
         */
