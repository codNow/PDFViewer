...
import com.sasha.pdfviewer.adapter.LockFolderAdapter;
...
public class EncryptedFolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encrypted_folder);
        ...
        toolbar.setTitle("Protected Pdf");
    ...
    private void getPdfFileForBelowB(){
        ...
        pdfAdapter = new LockFolderAdapter(getApplicationContext(), mediaList);
        recyclerView.setAdapter(pdfAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(this,
                RecyclerView.VERTICAL, false));
        PdfModel item ;
        String file_ext = ".pdf";
        String folderName = "Locked PDF";
    ...
    private ArrayList<PdfModel> loadFiles(Context context){
        ...
        if (cursor != null){
            while (cursor.moveToNext()){
                ...
                if (subString.contains("Locked PDF")) {
