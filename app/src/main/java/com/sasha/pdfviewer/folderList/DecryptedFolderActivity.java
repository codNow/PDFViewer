...
import com.sasha.pdfviewer.adapter.UnlockFolderAdapter;
...
public class DecryptedFolderActivity extends AppCompatActivity {

    private RecyclerView recyclerView, wordRecyclerView;
    private ArrayList<PdfModel> mediaList = new ArrayList<>();
    private UnlockFolderAdapter pdfAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decrypted_folder);
    ...
    private ArrayList<File> getAllPdfFiles() {
    ...
    private void loadAllPdf() {
        ...
        pdfAdapter = new UnlockFolderAdapter(getApplicationContext(), mediaList);
    ...
    private ArrayList<PdfModel> loadFiles(Context context){
        ...
        if (cursor != null){
            while (cursor.moveToNext()){
                ...
                if (subString.contains("Unlocked PDF")) {
    ...
    private void getPdfFileForBelowB(){
        ...
        PdfModel item ;
        String file_ext = ".pdf";
        String folderName = "Unlocked PDF";
